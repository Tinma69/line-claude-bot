// おすそわけ 名刺 個別ファイル生成（1人=表面+裏面の2ページ・塗り足し込み97×61mm）
...
const members = [
  { id: "1_sato", name: "佐藤 勇飛", roma: "Yuhi Sato", role: "CEO / 代表", tel: "080-9579-0336" },
  { id: "2_umemoto", name: "梅本 幸汰", roma: "Kota Umemoto", role: "COO / 副代表", tel: "080-1486-0699" },
  { id: "3_sekimoto", name: "関本 達也", roma: "Tatsuya Sekimoto", role: "営業", tel: "090-2041-6170" },
  { id: "4_imai", name: "今井 蒼空", roma: "Sora Imai", role: "営業", tel: "080-5737-0249" },
  { id: "5_takekura", name: "竹倉 己博", roma: "Kihiro Takekura", role: "営業", tel: "080-8328-8015" },
  { id: "6_yoshizawa", name: "吉澤 駿佑", roma: "Shunsuke Yoshizawa", role: "営業", tel: "080-8692-5354" },
  { id: "7_okamoto", name: "岡本 悠希", roma: "Yuki Okamoto", role: "営業", tel: "090-2948-4839" },
  { id: "8_tanikawa", name: "谷川 碧唯", roma: "Aoi Tanikawa", role: "営業", tel: "080-8308-6671" }
];

function addBack(pres) {
...
(async () => {
  for (const m of members) {
    ...
    addBack(pres);
    await pres.writeFile({ fileName: OUT + "meishi_" + m.id + ".pptx" });
    console.log("Created: meishi_" + m.id + ".pptx");
  }
})();
